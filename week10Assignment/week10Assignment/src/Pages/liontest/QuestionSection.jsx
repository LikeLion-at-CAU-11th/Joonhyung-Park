...
const QuestionSection = ({results,setContent,searchParams,setSearchParams}) => {
  ...
  const addToAnswerSheet = (id, answer) => {
    ...
    setIndex(id + 1); // i 값을 업데이트
    searchParams.set('problem',id+2);
